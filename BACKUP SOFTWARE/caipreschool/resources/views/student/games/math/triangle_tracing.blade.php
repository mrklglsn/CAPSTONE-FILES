...
<html lang="en-us">
    ...
    <link rel="stylesheet" href="{{ url('public/storage/games/Math/TriangleTracing/assets/css/reset.css') }}">
    <link rel="stylesheet" href="{{ url('public/storage/games/Math/TriangleTracing/assets/css/style.css') }}">

    <title>Triangle Tracing</title>
  </head>
  <body>
    <nav class="mb-1 navbar navbar-expand-lg text-white-50 nav-menu">
      <a class="btn" href="englishArea.html"><i class="fa fa-arrow-left fa-2x"></i></a>
    ...
    <div class="container">
      <div class="row pt-3 pl-3">
        <h3 class="account-settings">Trace the Triangle Shape</h3>
    ...
    <script src="{{ url('public/storage/games/Math/TriangleTracing/MyLoader.js') }}"></script>
    <script>
      var buildUrl = "../../../public/storage/games/Math/TriangleTracing/Build";
      var studentId =  parseInt($('#loggedStudent').val());
      createUnityInstance(document.querySelector("#unity-canvas"), {
        dataUrl: buildUrl+"/TriangleTracing.data",
        frameworkUrl: buildUrl+"/TriangleTracing.framework.js",
        codeUrl: buildUrl+"/TriangleTracing.wasm",

...
<html lang="en-us">
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ url('public/storage/games/Math/MatchTheShapesToObjects/assets/css/reset.css') }}">
    <link rel="stylesheet" href="{{ url('public/storage/games/Math/MatchTheShapesToObjects/assets/css/style.css') }}">

    <title>Math | Activity 3</title>
  </head>
  <body>
    ...
    <div class="container">
      <div class="row pt-3 pl-3">
        <h3 class="account-settings">Match the Shapes to Correct Objects</h3>
    ...
    <!-- SHAPE CONNECT -->
    <div class="modal fade endGame" id="shapeConnect" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-keyboard="false" data-backdrop="static" aria-hidden="true">
      <div class="modal-dialog modal-xl  modal-dialog-centered" role="document" >
        <div class="modal-content border-0" style="background-color: transparent;">
          <div class="modal-body mx-auto" style="position: relative">
            <h4 class="tutorial-text text-white">Drag the object to its shape
              <a href="#" class="btn text-white"><i class="fa fa-volume-up"></i></a>
            </h4>
            <img src="{{ url('public/frontend/images/shape_Connect.gif') }}" width="100%">
    ...
    <script src="{{ url('public/storage/games/Math/MatchTheShapesToObjects/MyLoader.js') }}"></script>
    <script>
      var buildUrl = "../../../public/storage/games/Math/MatchTheShapesToObjects/Build";
      var studentId =  parseInt($('#loggedStudent').val());
      createUnityInstance(document.querySelector("#unity-canvas"), {
        dataUrl: buildUrl + "/MatchTheShapesToObjects.data",
        frameworkUrl: buildUrl + "/MatchTheShapesToObjects.framework.js",
        codeUrl: buildUrl + "/MatchTheShapesToObjects.wasm",
        ...
        myGameInstance.SendMessage('Start_Alphabet_A', 'setStudentId', studentId);
      });
    </script>

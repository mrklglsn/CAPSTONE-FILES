...
<html lang="en-us">
  <head>
    ...
    <link rel="stylesheet" href="{{ url('public/storage/games/Math/CountingObjects/assets/css/reset.css') }}">
    <link rel="stylesheet" href="{{ url('public/storage/games/Math/CountingObjects/assets/css/style.css') }}">
  ...
  <body>
    ...
    <div class="container">
      <div class="row pt-3 pl-3">
        <h3 class="account-settings">Count the number of objects</h3>
    ...
    <!-- COUNTING OBJECT -->
    <div class="modal fade endGame" id="countingObject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  data-backdrop="static" aria-hidden="true" aria-hidden="true">
      <div class="modal-dialog modal-xl  modal-dialog-centered" role="document" >
        <div class="modal-content border-0" style="background-color: transparent;">
          <div class="modal-body mx-auto" style="position: relative">
            <h4 class="tutorial-text text-white">Press the correct number for each object
              <a href="#" class="btn text-white"><i class="fa fa-volume-up"></i></a>
            </h4>
            <img src="{{ url('public/frontend/images/Counting-Object.gif') }}" width="100%">
            <a class="button-start" href="#" data-dismiss="modal" aria-hidden="true" style="display: none">
              <img src="{{ url('public/frontend/images/tart_button.gif') }}" width="50%" class="btn">
            </a>
          </div>
        </div>
      </div>
    </div>
    <script src="{{ url('public/storage/games/Math/CountingObjects/MyLoader.js') }}"></script>
    <script>
      var buildUrl = "../../../public/storage/games/Math/CountingObjects/Build";
      var studentId =  parseInt($('#loggedStudent').val());
      createUnityInstance(document.querySelector("#unity-canvas"), {
        dataUrl: buildUrl + "/CountingObjects.data",
        frameworkUrl: buildUrl + "/CountingObjects.framework.js",
        codeUrl:  buildUrl + "/CountingObjects.wasm",

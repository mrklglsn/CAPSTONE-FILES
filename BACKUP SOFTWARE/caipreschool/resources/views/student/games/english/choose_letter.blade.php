...
<html lang="en-us">
    ...
    <link rel="stylesheet" href="{{ url('public/storage/games/English/ChooseTheCorrectLetter/assets/css/reset.css') }}">
    <link rel="stylesheet" href="{{ url('public/storage/games/English/ChooseTheCorrectLetter/assets/css/style.css') }}">

    <title>English | Activity 1</title>
  </head>
  <body>
    ...
    <div class="container">
      <div class="row pt-3 pl-3">
        <h3 class="account-settings">Choose the correct first letter of an object</h3>
    ...
    <!-- Guess the first letter of an object -->
    <div class="modal fade endGame" id="guessFirstLetter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  data-backdrop="static" aria-hidden="true" aria-hidden="true">
      <div class="modal-dialog modal-xl  modal-dialog-centered" role="document" >
        <div class="modal-content border-0" style="background-color: transparent;">
          <div class="modal-body mx-auto" style="position: relative">
            <h4 class="tutorial-text text-white">Press the first correct letter for each object
              <a href="#" class="btn text-white"><i class="fa fa-volume-up"></i></a>
            </h4>
            <img src="{{ url('public/frontend/images/Guess_the_animal.gif') }}" width="100%">
            <a class="button-start start-btn" href="#" data-dismiss="modal" aria-hidden="true" style="display: none">
    ...
    <script src="{{ url('public/storage/games/English/ChooseTheCorrectLetter/MyLoader.js') }}"></script>
    <script>
      var buildUrl = "../../../public/storage/games/English/ChooseTheCorrectLetter/Build";
      var studentId =  parseInt($('#loggedStudent').val());
      createUnityInstance(document.querySelector("#unity-canvas"), {
        dataUrl: buildUrl+"/ChooseTheCorrectLetter.data",
        frameworkUrl: buildUrl+"/ChooseTheCorrectLetter.framework.js",
        codeUrl: buildUrl+"/ChooseTheCorrectLetter.wasm",

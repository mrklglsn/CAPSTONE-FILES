...
<html lang="en-us">
  <head>
    ...
    <link rel="stylesheet" href="{{ url('public/storage/games/English/LetterGuessingv2/assets/css/reset.css') }}">
    <link rel="stylesheet" href="{{ url('public/storage/games/English/LetterGuessingv2/assets/css/style.css') }}">

    <title>English | Activity 2</title>
  </head>
  <body>
    ...
    <div class="container">
      <div class="row pt-3 pl-3">
        <h3 class="account-settings">Choose the correct first letter of the object</h3>
    ...
    <!-- Guess the letter -->
    <div class="modal fade endGame" id="guessLetter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  data-backdrop="static" aria-hidden="true" aria-hidden="true">
      <div class="modal-dialog modal-xl  modal-dialog-centered" role="document" >
        <div class="modal-content border-0" style="background-color: transparent;">
          <div class="modal-body mx-auto" style="position: relative">
            <h4 class="tutorial-text text-white">Press the correct letter for each object
              <a href="#" class="btn text-white"><i class="fa fa-volume-up"></i></a>
            </h4>
            <img src="{{ url('public/frontend/images/Guess_the_letter.gif') }}" width="100%">
    ...
    <script src="{{ url('public/storage/games/English/LetterGuessingv2/MyLoader.js') }}"></script>
    <script>
      var buildUrl = "../../../public/storage/games/English/LetterGuessingv2/Build";
      var studentId =  parseInt($('#loggedStudent').val());
      createUnityInstance(document.querySelector("#unity-canvas"), {
        dataUrl: buildUrl + "/LetterGuessingv2.data",
        frameworkUrl: buildUrl + "/LetterGuessingv2.framework.js",
        codeUrl:  buildUrl + "/LetterGuessingv2.wasm",

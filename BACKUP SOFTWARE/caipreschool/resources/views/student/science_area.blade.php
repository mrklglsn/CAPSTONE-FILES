        ...
        <div class="tab-content">
            <div id ="home" class=" tab-pane fade active show">
                <div class="row pt-3 pl-3">
                    <h3 class="account-settings">Science Activities</h3>
                </div>
                <hr class="hr-line">
                <div class="row fluid text-center">
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <a class="btn" href="{{ route('student/science_area/activity1') }}">
                            <img src="{{ url('public/frontend/images/game_logos/guess_the_animal.png') }}" class="card-img-top">
                            <h5 class="card-title text-center pt-1">Activity 1</h5>
                        </a>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <a class="btn" href="{{ route('student/science_area/activity2') }}">
                            <img src="{{ url('public/frontend/images/game_logos/guess_the_sound.png') }}" class="card-img-top">
            ...
            <div id ="menu1" class="tab-pane fade">
                <div class="row pt-3 pl-3">
                    <h3 class="account-settings">Science Assessments</h3>
                </div>
                <hr class="hr-line">
                <div class="row fluid text-center">

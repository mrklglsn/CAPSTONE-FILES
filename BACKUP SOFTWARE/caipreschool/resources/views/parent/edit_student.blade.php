@include('parent-layout.navbars.navbar2')
        <div class="container">
            <div class="row pt-5 pl-3">
                <h3 class="account-settings">Edit Student Profile</h3>
            </div>
            <hr class="hr-line">
                    ...
                    <tbody class ="tfont">
                        <form role="form" enctype="multipart/form-data" id="addStudentForm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img id="blah" src="{{ url('public/storage/images/user1.png') }}" width="150" height="150"  />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="fullName" id="fullName" value="{{ $student->student_name }}" class="form-control" required> 
                                    <input type="text" name="student_id" id="student_id" value="{{ $student->id }}" class="form-control" hidden> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="nickName" id="nickName" value="{{ $student->nickname }}"  class="form-control" required> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="date" name="birthDate" id="birthDate" value="{{ $student->birth_date }}" class="form-control datepicker" required> 
